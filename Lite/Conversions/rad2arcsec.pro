FUNCTION rad2arcsec, rad, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in radians "rad" to angles in arcseconds. The
;              input parameter "rad" may be a scalar, vector, or array.
;
; Input Parameters:
;
...
;   parameter "rad", where each element represents an angle in units of arcseconds.
;
; Keywords:
;
...
return, (648000.0D/get_dbl_pi())*rad
