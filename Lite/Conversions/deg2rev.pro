FUNCTION deg2rev, deg, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in degrees "deg" to numbers of revolutions. The
...
;   parameter "deg", where each element represents a number of revolutions.
;
; Keywords:
;
