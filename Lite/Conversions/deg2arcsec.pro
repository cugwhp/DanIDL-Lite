FUNCTION deg2arcsec, deg, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in degrees "deg" to angles in arcseconds. The
...
;   parameter "deg", where each element represents an angle in units of arcseconds.
;
; Keywords:
;
