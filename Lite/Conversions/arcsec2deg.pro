FUNCTION arcsec2deg, arcsec, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in arcseconds "arcsec" to angles in degrees. The
...
;   parameter "arcsec", where each element represents an angle in units of degrees.
;
; Keywords:
;
