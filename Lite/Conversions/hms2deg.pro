FUNCTION hms2deg, str, status, NO_PAR_CHECK = no_par_check
...
;              angles in degrees. The input parameter "str" may be a scalar, vector, or
;              array.
;
; Input Parameters:
;
...
;   parameter "str", where each element represents an angle in units of degrees and in the
;   range 0 to 360 degrees. Where elements of "str" are not valid representations of a time
...
;Convert the time strings stored in "str" into angles in degrees
angles = 15.0D*hms2hours(str, status, /NO_PAR_CHECK)
