FUNCTION arcsec2rad, arcsec, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in arcseconds "arcsec" to angles in radians. The
...
;   parameter "arcsec", where each element represents an angle in units of radians.
;
; Keywords:
;
...
return, (get_dbl_pi()/648000.0D)*arcsec
