FUNCTION rad2rev, rad, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in radians "rad" to numbers of revolutions. The
...
;   parameter "rad", where each element represents a number of revolutions.
;
; Keywords:
;
