FUNCTION rev2arcmin, rev, status, NO_PAR_CHECK = no_par_check

; Description: This function converts numbers of revolutions "rev" to angles in arcminutes. The
...
;   parameter "rev", where each element represents an angle in units of arcminutes.
;
; Keywords:
;
