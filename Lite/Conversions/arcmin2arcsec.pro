FUNCTION arcmin2arcsec, arcmin, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in arcminutes "arcmin" to angles in arcseconds. The
...
;   parameter "arcmin", where each element represents an angle in units of arcseconds.
;
; Keywords:
;
