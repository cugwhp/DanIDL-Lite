FUNCTION rad2deg, rad, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in radians "rad" to angles in degrees. The input
...
;   parameter "rad", where each element represents an angle in units of degrees.
;
; Keywords:
;
