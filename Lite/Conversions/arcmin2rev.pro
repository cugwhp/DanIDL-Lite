FUNCTION arcmin2rev, arcmin, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in arcminutes "arcmin" to numbers of revolutions. The
...
;   parameter "arcmin", where each element represents a number of revolutions.
;
; Keywords:
;
