FUNCTION deg2rad, deg, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in degrees "deg" to angles in radians. The input
...
;   parameter "deg", where each element represents an angle in units of radians.
;
; Keywords:
;
