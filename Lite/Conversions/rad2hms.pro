FUNCTION rad2hms, angle, ndp, status, NO_PAR_CHECK = no_par_check

; Description: This function converts angles in radians "angle" to strings of the format
...
;   0 to 24 hours. Where elements of "angle" are not valid angles in the range 0 to 2*pi radians,
...
return, hours2hms((12.0D/get_dbl_pi())*angle, ndp, status, /NO_PAR_CHECK)
