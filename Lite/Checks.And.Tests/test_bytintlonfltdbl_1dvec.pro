PRO test_bytintlonfltdbl_1dvec, data, status, xsize, dtype
...
;              contain a one-dimensional vector of numbers of the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE,
...
;                vector of numbers of the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE would have.
;
; Output Parameters:
;
;   status - INTEGER - The parameter "status" is set to "1" if the parameter "data" is a one-dimensional
;                      vector of numbers of the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE. Otherwise, the
...
;                     2, 3, 4, and 5 correspond to variable types of BYTE, INTEGER, LONG, FLOAT, and DOUBLE,
;                     respectively.
;
...
;If "data" is one-dimensional and contains numbers of the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE, then
