PRO test_num_3darr, data, status, xsize, ysize, zsize, dtype

; Description: This module tests that the parameter "data" contains a three-dimensional array of number data.
;              In other words, it checks that "data" is non-empty, contains numbers of any of the types BYTE,
;              INTEGER, LONG, FLOAT, DOUBLE, UINT, ULONG, LONG64, or ULONG64, and has exactly three dimensions.
;              If the module finds that "data" does indeed contain a three-dimensional array of number data,
...
;                      or ULONG64, with exactly three dimensions. Otherwise, the module sets the value of
;                      "status" to "0".
...
;If "data" is three-dimensional and contains numbers of any of the types BYTE, INTEGER, LONG, FLOAT, DOUBLE,
