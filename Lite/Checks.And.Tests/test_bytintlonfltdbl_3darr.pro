PRO test_bytintlonfltdbl_3darr, data, status, xsize, ysize, zsize, dtype

; Description: This module tests that the parameter "data" contains a three-dimensional array of numbers of
;              the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE. If the module finds that "data" does indeed
;              contain a three-dimensional array of numbers of the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE,
;              then it also determines the array size and saves this information in the parameters "xsize",
;              "ysize", and "zsize". Finally, the module also returns the IDL type code of the parameter
;              "data".
;
; Input Parameters:
;
...
;                      array of numbers of the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE. Otherwise, the
;                      module sets the value of "status" to "0".
...
;If "data" is three-dimensional and contains numbers of the type BYTE, INTEGER, LONG, FLOAT, or DOUBLE, then
