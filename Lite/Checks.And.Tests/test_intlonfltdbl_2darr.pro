PRO test_intlonfltdbl_2darr, data, status, xsize, ysize, dtype
...
;              contain a two-dimensional array of numbers of the type INTEGER, LONG, FLOAT, or DOUBLE,
;              then it also determines the array size and saves this information in the parameters
;              "xsize" and "ysize". Finally, the module also returns the IDL type code of the parameter
;              "data".
;
; Input Parameters:
;
;   data - ANY - The parameter to be tested whether or not it satisfies the properties that a
;                two-dimensional array of numbers of the type INTEGER, LONG, FLOAT, or DOUBLE would have.
;
; Output Parameters:
;
...
;If "data" is two-dimensional and contains numbers of the type INTEGER, LONG, FLOAT, or DOUBLE, then set
