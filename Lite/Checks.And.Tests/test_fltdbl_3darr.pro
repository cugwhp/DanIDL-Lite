PRO test_fltdbl_3darr, data, status, xsize, ysize, zsize, dtype
...
;              three-dimensional array of numbers of the type FLOAT or DOUBLE, then it also determines
...
;                three-dimensional array of numbers of the type FLOAT or DOUBLE would have.
;
; Output Parameters:
;
;   status - INTEGER - The parameter "status" is set to "1" if the parameter "data" is a three-dimensional
;                      array of numbers of the type FLOAT or DOUBLE. Otherwise, the module sets the value
;                      of "status" to "0".
...
;If "data" is three-dimensional and contains numbers of the type FLOAT or DOUBLE, then set the value of
