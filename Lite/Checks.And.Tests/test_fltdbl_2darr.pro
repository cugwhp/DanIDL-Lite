PRO test_fltdbl_2darr, data, status, xsize, ysize, dtype

; Description: This module tests that the parameter "data" contains a two-dimensional array of numbers
;              of the type FLOAT or DOUBLE. If the module finds that "data" does indeed contain a
;              two-dimensional array of numbers of the type FLOAT or DOUBLE, then it also determines
...
;                two-dimensional array of numbers of the type FLOAT or DOUBLE would have.
;
; Output Parameters:
;
;   status - INTEGER - The parameter "status" is set to "1" if the parameter "data" is a two-dimensional
;                      array of numbers of the type FLOAT or DOUBLE. Otherwise, the module sets "status"
;                      to a value of "0".
...
;                     4 and 5 correspond to variable types of FLOAT and DOUBLE, respectively.
;
...
;If "data" is two-dimensional and contains numbers of the type FLOAT or DOUBLE, then set the value of
