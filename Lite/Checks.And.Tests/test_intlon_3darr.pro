PRO test_intlon_3darr, data, status, xsize, ysize, zsize, dtype
...
;              three-dimensional array of numbers of the type INTEGER or LONG, then it also determines the
;              array size and saves this information in the parameters "xsize", "ysize", and "zsize".
...
;                three-dimensional array of numbers of the type INTEGER or LONG would have.
;
; Output Parameters:
;
;   status - INTEGER - The parameter "status" is set to "1" if the parameter "data" is a three-dimensional
;                      array of numbers of the type INTEGER or LONG. Otherwise, the module sets the value
;                      of "status" to "0".
...
;If "data" is three-dimensional and contains numbers of the type INTEGER or LONG, then set the value of
